...
if (isset($_POST["btnsubmit"])) {
    ...
    try {
        $statement->execute([
            ...
            ':dob' => '', // Provide default or valid value if missing
            ':phone' => $_POST['txtphone'],
            ':address' => '', // Provide default or valid value if missing
            ':qualification' => '', // Provide default or valid value if missing
            ':dept' => $_POST['cmddept'],
            ':employee_type' => $_POST['cmdemployeetype'],
            ':date_appointment' => '', // Provide default or valid value if missing
                            ...
                            <form method="post" id="regForm" class="form form-horizontal" novalidate autocomplete="off" action="">
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-12 form-group mb-2">
                                            <div class="controls">
                                            <input class="form-control" type="number" placeholder="Gross Pay" required data-validation-required-message="Gross Pay is required" data-val="true" data-val-required="The Gross Pay field is required." id="txtgross_pay" name="txtgross_pay" value="">
